      ...
      <div className="about-course">
        <div className="about-course-container">
          <div className="about-course-content">
            <div className="player-wrapper">
              <ReactPlayer
                url="https://youtu.be/aTH8CW17hDM"
              ...
              <div>
                <div className="flex-col">
                  ...
                  <div className="mt-16">
                    ...
                    <a
                      href="https://pay.hotmart.com/H11831014O?checkoutMode=0&bid=1590880141721"
                      className="btn"
                    >
                      Compre agora
                    </a>
        ...
        <section className="content-info">
          ...
          <div className="description">
            <p>
              Este é um curso para aprender a usar o Adobe Illustrator do zero!
              Nessas aulas, você aprenderá das ferramentas mais básicas às mais
              avançadas do programa. O projeto final será uma ilustração
              contemporânea usando várias ferramentas do Adobe Illustrator. Você
              realizará diferentes exercícios criativos para desenvolver seu
              olhar de designer e aprender a integrar suas ilustrações em seus
